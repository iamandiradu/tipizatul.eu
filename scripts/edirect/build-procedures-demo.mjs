#!/usr/bin/env node
// Builds public/procedures-demo.json by joining the eDirect procedure scrape
...
// the demo has enough variety to exercise the UI without bloating the SPA.
...
const OUT_PATH = path.join(__dirname, '..', '..', 'public', 'procedures-demo.json')
